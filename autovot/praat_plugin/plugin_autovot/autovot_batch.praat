...
# Variables passed to autovot_batch.praat from autovot_wrapper.praat:
#	- stop_tier

# Disable warnings when sound gets clipped after resampling/saving
warn = 0
...
############################################
# This block now happens in autovot_wrapper.praat
...
if current_rate <> 16000
	...
	if warn == 1
		...
		nowarn Save as WAV file: sound_filename$
	endif
